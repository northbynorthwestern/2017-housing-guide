...
PROJECT_SLUG = '2017-housing-guide'

# Project name to be used in file paths
PROJECT_FILENAME = '2017_housing_guide'

# The name of the repository containing the source
REPOSITORY_NAME = '2017-housing-guide'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1j6bY0gFjhlpwALhADBUWkFhDrLPvsqYANG5UkwKsGPI'
